      ...
      <div className="flex flex-col lg:flex-row items-start gap-8">
        ...
        <div className="w-full lg:w-2/3 space-y-6 text-gray-700 dark:text-gray-300">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 gap-4 text-indigo-600 dark:text-indigo-400 text-3xl">
              <div className="flex flex-col items-center">
                ...
                <div className="flex flex-col items-center text-indigo-600 dark:text-indigo-400 text-3xl">
                <FaPython />
